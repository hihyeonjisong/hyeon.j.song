...
public class HomeWork2 {
	...
	public static void main(String[] args) {
		question1(); // 앞에 주석 넣으면 밑의 question1전체 주석처리됨
		question2();
	...
	public static void question1() {
		...
		while(true) { 
			...
			if( ans <question) {
				System.out.println("더 큰 수을 입력하세요.");		
			}else if(ans > question) {
				System.out.println("더 작은 수을 입력하세요.");	
			}else {
	...
	public static void question2(){
		...
		//  윤년 : 4의 배수이면서 100의 배수가 아니면서 400의의 배수해가 되는 해
		System.out.print("년도 입력 : ");
		int year=sc.nextInt();		//방법2
									//boolean b4 = year%4==0;
